...
const APIKey = '194f99b6e79976f4d65ca299'
...
const getErrormessage = errorType =>
  ({
    'unsupported-code':
      'Não oferecermos suporte ao código de moeda fornecido (consulte moedas suportadas...)',
    'malformed-request':
      'Alguma parte do seu pedido não segue a estrutura mostrada acima.',
